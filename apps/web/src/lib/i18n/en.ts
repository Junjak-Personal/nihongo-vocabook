...
const en: Translations = {
  ...
  quiz: {
    ...
    dailyGoalReachedDesc: 'Come back tomorrow for your next session.',
  ...
  settings: {
    ...
    dailyGoalDesc: 'Total cards per day (new + review mixed). Hard cap — never exceeded by the main quiz.',
    exampleQuizRatio: 'Example quiz ratio',
    exampleQuizRatioDesc: 'Chance that a card is shown as a 3-choice example quiz instead of the standard flashcard.',
    ...
    notificationEnabledDesc: 'Push notification at the set time (KST), only if today\'s goal isn\'t done.',
    notificationTime: 'Reminder time',
    notificationHour: 'Hour',
    notificationMinute: 'Minute',
    notificationPermissionDenied: 'Notification permission denied',
    notificationPermissionDeniedDesc: 'Enable notifications in your browser settings to get reminders.',
  },
  wordbooks: {
    title: 'Wordbooks',
  ...
  achievements: {
    ...
    dailyGoalStreak7: '7-Day Goal Streak',
    dailyGoalStreak7Desc: 'Hit your daily goal 7 days in a row',
